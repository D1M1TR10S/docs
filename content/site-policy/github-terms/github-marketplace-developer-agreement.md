...
* (vii) ensuring the name and branding of its Developer Products do not imitate existing brands or companies that the publisher is not directly affiliated with. Text like "for GitHub" may be used in the listing name as long as it clearly indicates an integration with GitHub, and not an affiliation. Violations may result in a request publish being denied or the listing being taken down from the marketplace.
